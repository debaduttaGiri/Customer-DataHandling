...
namespace MVC_DataHandling.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void SendMail(IdentityUser identityUser, string requestLink, string subject)
        {
            ...
            MailboxAddress fromAddress = new MailboxAddress("Customer Support", "debugiri.dev@gmail.com");
            ...
            smtpClient.Authenticate("debugiri.dev@gmail.com", "scpa xtkb xxbh nvic");
